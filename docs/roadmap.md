...
- protocol 1.14 session verified across a real Apple-container ARM64 VM
...
- next: capture and validate a real dispatch of each remaining 5 true-use software-FP64 matrix pipeline, implement broader descriptor/format coverage, and revisit the final 64-bit atomic compare-exchange shader only if Metal gains a correct primitive
